  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row">
        ...
        {/* Content Section */}
        <div className="w-full lg:w-1/2 p-6 mb-[20%] lg:mt-[12%] relative">
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex justify-center gap-10 items-center">
        <button
          className={`bg-white border border-2 ${userType === "mentor" ? "border-yellow-500" : "border-blue-500"}  text-gray-700 rounded-full w-16 h-16 flex items-center justify-center transition-all ${colors.shadow}`}
          onClick={handleAction}
        >
          <FaTimes size={28} />
        </button>
        <button
          className={`bg-white ${userType === "mentor" ? "text-yellow-500 border-yellow-500" : "text-blue-500 border-blue-500"} border border-2   rounded-full w-16 h-16 flex items-center justify-center transition-all ${colors.shadow}`}
          onClick={handleAction}
        >
          <FaHeart size={28} />
        </button>
